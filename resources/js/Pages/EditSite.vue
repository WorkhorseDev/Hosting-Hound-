      ...
      <vf-form @submit.prevent="submit" id="addSite">
        <div class="main-panel main-panel_edit">
          ...
          <div class="panel-controls flex flex-row justify-end items-center">
            ...
            <button class="btn-edit hidden md:inline">
              <i class="fa-solid fa-pencil"></i>
            </button>
          </div>
        </div>
        <main class="main-content main-content_edit add-site">
          <div class="inner">
              ...
              <div>
                ...
                <div class="site-name-wrap">
                    ...
                    <div class="right-group">
                        <div class="mb-5 right">
                            ...
                            <div class="mt-2">
                                <input  v-model="site.name" required id="name" name="name" type="text" autocomplete="name"
                ...
                <div class="mb-5">
                  <label for="shared_with" class="block text-sm font-medium leading-6 text-gray-900">Shared
                    with:</label>
                  <div class="mt-2">
                    <textarea v-model="site.shared_with" id="shared_with" name="shared_with" rows="3"
                ...
                <div class="mb-5">
                  ...
                  <div class="mt-2">
                    <textarea v-model="site.notes" id="notes" name="notes" rows="3" placeholder="Enter notes here"
                              class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                  </div>
                </div>
              </div>
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group m-0">
                          ...
                          <div class="form-group form-group-icon">
                            <VueDatePicker format="dd/MM/yyyy" model-type="format" v-model="form.provider.renewal_date"></VueDatePicker>
                    ...
                    <div class="form-group-wrap p-6 pt-4">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group m-0">
                          <label>Renewal Date</label>
                          <div class="form-group form-group-icon">
                            <VueDatePicker format="dd/MM/yyyy" model-type="format" v-model="form.software.renewal_date"></VueDatePicker>
                            <i class="fa-solid fa-calendar"></i>
                          </div>
                        </div>
                      </div>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      if(this.form.softwares && this.form.softwares.length === 0) {
